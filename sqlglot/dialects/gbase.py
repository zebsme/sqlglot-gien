    ...
    class Parser(parser.Parser):
        ...
        CONSTRAINT_PARSERS = {
            **parser.Parser.CONSTRAINT_PARSERS,
            ...
            "UNIQUE": lambda self: self._parse_index_constraint(kind="UNIQUE"),
            "UNIQUE INDEX": lambda self: (self._match(TokenType.UNIQUE), self._match_texts(("INDEX", "KEY")), self._parse_index_constraint(kind="UNIQUE"))[2],
        }
