...
WHERE
  Action = 'UPDATE'""",
        ...
        self.validate_all(
            ...
            read={
                "postgres": "CREATE TABLE tbl (id INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 10) PRIMARY KEY)",
            ...
            write={
                ...
                "postgres": "CREATE TABLE tbl (id INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 10 INCREMENT BY 1) PRIMARY KEY)",
            },
        )
        self.validate_all(
