...
def handle_column_definition(expr, table_name, tables, comments, primary_keys, dialect):
    ...
    if expr.kind.expressions:
        try:
            length = expr.kind.expressions[0].this.this if len(expr.kind.expressions) > 0 else None
            scale = expr.kind.expressions[1].this.this if len(expr.kind.expressions) > 1 else None
        except Exception as e:
            length, scale = None, None
...
if __name__ == "__main__":
    ...
    # folder = '/Users/ynkang/Downloads/抽取代码信息/DDL/failed/OceanBase-oracle-0910.sql'
    ...
    dialect_map= {
        ...
        'postgreSQL': 'postgres',
        'dm': 'dm',
        'gaussDB': 'gaussdb', #  postgres
        'TCHouse': 'tchouse', #  postgres
        'TBDS': 'databricks',
        'hive': 'hive',
        'FMRS': 'databricks',
        'TranswarpArgoDB': 'databricks',
        ...
        'Informix': 'informix',
        'Hudi_Spark': "spark",
        'Hudi_Flink': "databricks",
        'mysql_test': 'mysql',
        'mysql1': 'mysql',
        'hive_test': 'hive',
        'postgreSQL_test': 'postgres',
        'oracle_test':'oracle',
        'gbase_test': 'mysql',
        'gbase_test_1': 'mysql',
        'argodb_test': 'databricks',
        'argodb': 'databricks',
        'DWS': 'dws',
        'HBASE': 'hbase',
        'datamodel_dm':'mysql',
        'dm_test': 'mysql',
        'hwmrs':'databricks',
        'mysql_multi_out11':'mysql',
        'TBDS': 'databricks',
        'TranswarpArgoDB_test':'databricks',
        ...
        '星环Argodb':'databricks',
        'tbds': 'databricks',
        '星环inceptor':'transwarpinceptor',
        'ddl':'mysql',
        '易鲸捷':'qianbasempp',
        'hudi-Spark': 'Hudi_Spark',
        'hudi-flink': "Hudi_Flink",
        '达梦_分区':"dm",
        '达梦2025-05-26':'dm',
        'GBASE_TEST_分区':'mysql',
        'tdsql':'mysql',
        'GBASE_TEST_分区':'mysql',
        'DWS_index':'dws',
        'dwstable_081802_12025-08-18': 'dws',
        'dwstable_081802_22025-08-18': 'dws',
        'dwstable_0818022025-08-18': 'dws',
        'DWS2025-08-18':'dws',
        'mysql-test2':'mysql',
        'DWS2025-08-12':'dws',
        'DWS_0813':'dws',
        'DWS_test':'dws',
        'hudi-flink':'databricks',
        'hudi-Spark':'hudi_spark',
        'DWStable_081802_12025-08-18':'dws',
        'DWStable_0818022025-08-18':'dws',
        'DWS': 'dws',
        'DWS2025-08-18':'dws',
        'DWStable_081802_22025-08-18':'dws',
        'Hudi_spark-0811':'hudi_spark',
        'hudi-spark-2025-08-07':'hudi_spark',
        'hudi-Spark_test':'hudi_spark',
        'DWS_index':'dws',
        'qianBaseMPP':'qianbasempp',
        'FMRS':'fmrs',
        'hwmrs_test':'fmrs',
